...
from app.services.services.mcp_service import (
...
from app.services.services.skill_service import (
...
from app.services.services.skill_fs import (
...
async def get_mcp_tools(name: str) -> Dict[str, Any]:
    """获取 MCP 服务的工具列表"""
    from app.services.services.mcp_service import get_mcp_server_by_name, list_mcp_tools
...
async def get_mcp_resources(name: str) -> Dict[str, Any]:
    ...
    from app.services.services.mcp_service import get_mcp_server_by_name, list_mcp_resources
