                ...
                <div className="p-4">
                  ...
                  {a.id && (
                    <div className="mb-2 flex items-center gap-1.5">
                      <code className="flex-1 truncate rounded bg-gray-100 px-2 py-0.5 text-xs text-gray-500 font-mono dark:bg-dark-3 dark:text-gray-400">
                        {a.id}
                      </code>
                      <button
                        type="button"
                        ...
                        className="shrink-0 rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-3"
                        title="复制 ID"
                      >
