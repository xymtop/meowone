...
from app.mcp.stdio_session import call_tool as call_stdio_tool
...
class CallMcpToolTool(BaseTool):
    ...
    async def _call_sse(self, ent, tname: str, args: Dict[str, Any]) -> str:
        try:
            from app.mcp.sse_client import call_mcp_tool_sse
    ...
    async def _call_streamable_http(self, ent, tname: str, args: Dict[str, Any]) -> str:
        try:
            from app.mcp.streamable_client import call_mcp_tool_streamable
